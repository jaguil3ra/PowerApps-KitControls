...
This is a custom control for DataSet. Allows comparing records through a radar chart.  Also Allows  enable to view the image of the records in the grid. 

This control was created using knockout js [Knockout JS](https://knockoutjs.com/) and [Chart JS](https://www.chartjs.org)  
