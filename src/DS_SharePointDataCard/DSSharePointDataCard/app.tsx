                ...
                <div className="customDocumentCard" key={element.id}>
                    ...
                    > 
                        ...
                        <div onClick={()=>{ this.selectRecord(element.id) }}>
                            ...
                            <DocumentCardStatus status="" className={element.isCheckOut ? "cardCheckOutStatus" : "cardCheckInStatus"} statusIcon={element.isCheckOut ? "PageCheckedOut" : "DocumentApproval"} >
                            </DocumentCardStatus>   
                        </div>
